    ...
    <section class="main-banner">
        <div class="container banner-container">
            ...
            <div class="banner-image">
                <img src="uploads/bg2.jpg" alt="Beauty Products Banner">
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="product-grid">
                <div class="product-card">
                    <img src="uploads/productImage.jpg" alt="Rabbit Oil Product 1">
                ...
                <div class="product-card">
                    <img src="uploads/productImage.jpg" alt="Rabbit Oil Product 2">
                    <h3>Nourish Your Hair with Rabbit Oil for Visible Results</h3>
                    <p>Experience the transformative power of our Rabbit Oil, solving all your hair care concerns.</p>
                    <a href="#" class="link">Shop now</a>
                </div>
                <div class="product-card">
                    <img src="uploads/productImage.jpg" alt="Rabbit Oil Product 3">
                    <h3>Nourish Your Hair with Rabbit Oil for Visible Results</h3>
                ...
                <div class="swiper-wrapper">
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        while ($row = mysqli_fetch_assoc($result)) {
                            $product_id = intval($row['Cl_ID']); // Sanitize product ID
                            echo '<div class="card">';
                            echo '<img src="uploads/' . htmlspecialchars($row['image'], ENT_QUOTES, 'UTF-8') . '" alt="' . htmlspecialchars($row['Clenser_name'], ENT_QUOTES, 'UTF-8') . '">';
                            echo '<h3>' . htmlspecialchars($row['Clenser_name'], ENT_QUOTES, 'UTF-8') . '</h3>';
                            echo '<p>Rs. ' . htmlspecialchars($row['Clenser_price'], ENT_QUOTES, 'UTF-8') . '</p>';
            ...
            <div class="pagination">
                ...
                <?php for ($i = 1; $i <= $total_pages; $i++): ?>
                    <a href="?page=<?php echo htmlspecialchars($i, ENT_QUOTES, 'UTF-8'); ?>" 
                       class="btn <?php if ($i == $page_number) echo 'active'; ?>">
